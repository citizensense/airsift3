        ...
        : listObservationsURLParam ? (
          <div className='flex flex-col sm:h-screen overflow-y-auto'>
            <div className='px-4 mb-4 pt-4 md:pt-6'>
              ...
              <p className='text-S my-4'>Document events that might indicate pollution or other environmental events. You can compare observations to Dustbox data, and incorporate this evidence into Data Stories.</p>
