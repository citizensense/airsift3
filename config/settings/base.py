...
MIGRATION_MODULES = {"sites": "airsift.contrib.sites.migrations"}
...
ADMINS = [("""Common Knowledge Co-operative""", "hello@commonknowledge.coop")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "airsift.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
CITIZENSENSE_DATA_API = 'https://citizensense.net:7000'
